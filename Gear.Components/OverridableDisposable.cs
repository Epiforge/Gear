...
namespace Gear.Components
{
    ...
    /// </summary>
    public abstract class OverridableDisposable : IDisposable, IAsyncDisposable, INotifyDisposalOverridden, INotifyDisposed, INotifyDisposing
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OverridableDisposable"/> class
        /// </summary>
        public OverridableDisposable()
        {
