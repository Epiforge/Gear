...
namespace Gear.Components
{
    ...
    public class ReadOnlyObservableRangeDictionary<TKey, TValue> : ReadOnlyRangeDictionary<TKey, TValue>, IObservableRangeDictionary<TKey, TValue>
    {
        ...
        /// Occurs when the dictionary changes
        /// </summary>
        public virtual event NotifyGenericCollectionChangedEventHandler<KeyValuePair<TKey, TValue>> GenericCollectionChanged;

        /// <summary>
        /// Occurs when the dictionary changes
        /// </summary>
        protected virtual event EventHandler<NotifyDictionaryChangedEventArgs<object, object>> NonGenericDictionaryChanged;
