...
namespace Gear.Components
{
    ...
    /// </summary>
    public abstract class OverridableSyncDisposablePropertyChangeNotifier : PropertyChangeNotifier, IDisposable, IDisposalStatus, INotifyDisposalOverridden, INotifyDisposed, INotifyDisposing
    {
        /// <summary>
