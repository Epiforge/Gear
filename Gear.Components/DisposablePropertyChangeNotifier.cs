...
{
    /// <summary>
    /// Provides a mechanism for releasing unmanaged resources asynchronously or synchronously and notifying about property changes
    /// </summary>
    public abstract class DisposablePropertyChangeNotifier : PropertyChangeNotifier, IDisposable, IAsyncDisposable, IDisposalStatus, INotifyDisposed, INotifyDisposing
    {
        /// <summary>
