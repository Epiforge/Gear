...
namespace Gear.Components
{
    ...
    /// </summary>
    public abstract class DisposablePropertyChangeNotifier : PropertyChangeNotifier, IDisposable, IAsyncDisposable, IDisposeStatus, INotifyDisposed, INotifyDisposing
    {
        /// <summary>
