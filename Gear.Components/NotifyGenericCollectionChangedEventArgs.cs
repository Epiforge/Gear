...
namespace Gear.Components
{
    ...
    public class NotifyGenericCollectionChangedEventArgs<T> : EventArgs, INotifyGenericCollectionChangedEventArgs<T>
    {
        ...
        public static explicit operator NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    return new NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedAction.Add, e.NewItems.Cast<T>().ToImmutableArray(), e.NewStartingIndex);
                case NotifyCollectionChangedAction.Move:
                    return new NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedAction.Move, (e.NewItems ?? e.OldItems).Cast<T>().ToImmutableArray(), e.NewStartingIndex, e.OldStartingIndex);
                case NotifyCollectionChangedAction.Remove:
                    return new NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedAction.Remove, e.OldItems.Cast<T>().ToImmutableArray(), e.OldStartingIndex);
                case NotifyCollectionChangedAction.Replace:
                    return new NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedAction.Replace, e.NewItems.Cast<T>().ToImmutableArray(), e.OldItems.Cast<T>().ToImmutableArray(), e.NewStartingIndex);
                case NotifyCollectionChangedAction.Reset:
                    return new NotifyGenericCollectionChangedEventArgs<T>(NotifyCollectionChangedAction.Reset);
                default:
        ...
        public static implicit operator NotifyCollectionChangedEventArgs(NotifyGenericCollectionChangedEventArgs<T> e)
        {
            ...
            {
                case NotifyCollectionChangedAction.Add:
                    return new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add, e.NewItems, e.NewStartingIndex);
                case NotifyCollectionChangedAction.Move:
                    return new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Move, e.NewItems, e.NewStartingIndex, e.OldStartingIndex);
                case NotifyCollectionChangedAction.Remove:
                    return new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, e.OldItems, e.OldStartingIndex);
                case NotifyCollectionChangedAction.Replace:
                    return new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace, e.NewItems, e.OldItems, e.NewStartingIndex);
                case NotifyCollectionChangedAction.Reset:
