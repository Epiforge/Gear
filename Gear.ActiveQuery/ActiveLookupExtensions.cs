...
namespace Gear.ActiveQuery
{
    public static class ActiveLookupExtensions
    {
        ...
        public static ActiveValue<bool> ActiveAll<TKey, TValue>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, bool>> predicate, ActiveExpressionOptions predicateOptions = null)
        {
        ...
        public static ActiveValue<bool> ActiveAny<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
        ...
        public static ActiveValue<bool> ActiveAny<TKey, TValue>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, bool>> predicate, ActiveExpressionOptions predicateOptions = null)
        {
            var activeValueAccess = new object();
            ActiveLookup<TKey, TValue> where;
            Action<bool> setValue = null;
        ...
        public static ActiveValue<TValue> ActiveAverage<TKey, TValue>(this IDictionary<TKey, TValue> source) =>
            ActiveAverage(source, (key, value) => value);

        public static ActiveValue<TResult> ActiveAverage<TKey, TValue, TResult>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, TResult>> selector, ActiveExpressionOptions selectorOptions = null)
        {
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveFirst<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveFirstOrDefault<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
            var keyComparer = source.GetKeyComparer() ?? Comparer<TKey>.Default;
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveLast<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
            var keyComparer = source.GetKeyComparer() ?? Comparer<TKey>.Default;
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveLastOrDefault<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
            var keyComparer = source.GetKeyComparer() ?? Comparer<TKey>.Default;
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
        ...
        public static ActiveValue<TValue> ActiveMax<TKey, TValue>(this IDictionary<TKey, TValue> source) =>
            ActiveMax(source, (key, value) => value);

        public static ActiveValue<TResult> ActiveMax<TKey, TValue, TResult>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, TResult>> selector, ActiveExpressionOptions selectorOptions = null)
        {
            ...
            void valueRemoved(object sender, NotifyDictionaryValueEventArgs<TKey, TResult> e)
            {
                lock (activeValueAccess)
                    if (comparer.Compare(activeValue.Value, e.Value) == 0)
                    {
                        try
                        {
                            var value = rangeActiveExpression.GetResults().Select(kr => kr.result).Max();
                            setOperationFault(null);
                            setValue(value);
                        }
                        catch (Exception ex)
        ...
        public static ActiveValue<TValue> ActiveMin<TKey, TValue>(this IDictionary<TKey, TValue> source) =>
            ActiveMin(source, (key, value) => value);

        public static ActiveValue<TResult> ActiveMin<TKey, TValue, TResult>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, TResult>> selector, ActiveExpressionOptions selectorOptions = null)
        {
            var comparer = Comparer<TResult>.Default;
            var activeValueAccess = new object();
            DictionaryRangeActiveExpression<TKey, TValue, TResult> rangeActiveExpression;
            ...
            void valueRemoved(object sender, NotifyDictionaryValueEventArgs<TKey, TResult> e)
            {
                lock (activeValueAccess)
                    if (comparer.Compare(activeValue.Value, e.Value) == 0)
                    {
                        try
                        {
                            var value = rangeActiveExpression.GetResults().Select(kr => kr.result).Min();
                            setOperationFault(null);
                            setValue(value);
                        }
                        catch (Exception ex)
        ...
        public static ActiveEnumerable<TResult> ActiveSelect<TKey, TValue, TResult>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, TResult>> selector, ActiveExpressionOptions selectorOptions = null)
        {
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveSingle<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
        ...
        public static ActiveValue<KeyValuePair<TKey, TValue>> ActiveSingleOrDefault<TKey, TValue>(this IDictionary<TKey, TValue> source)
        {
            var keyEqualityComparer = source.GetKeyEqualityComparer() ?? EqualityComparer<TKey>.Default;
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
        ...
        public static ActiveValue<TResult> ActiveSum<TKey, TValue, TResult>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, TResult>> selector, ActiveExpressionOptions selectorOptions = null)
        {
            var operations = new GenericOperations<TResult>();
            var activeValueAccess = new object();
            ActiveValue<TResult> activeValue = null;
        ...
        public static ActiveEnumerable<TValue> ToActiveEnumerable<TKey, TValue>(this IDictionary<TKey, TValue> source) =>
        ...
        public static ActiveValue<TValue> ActiveValueFor<TKey, TValue>(this IDictionary<TKey, TValue> source, TKey key)
        {
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
            {
        ...
        public static ActiveValue<TValue> ActiveValueForOrDefault<TKey, TValue>(this IDictionary<TKey, TValue> source, TKey key)
        {
            var elementFaultChangeNotifier = source as INotifyElementFaultChanges;
            if (source is INotifyDictionaryChanged<TKey, TValue> changingSource)
            {
        ...
        public static ActiveLookup<TKey, TValue> ActiveWhere<TKey, TValue>(this IDictionary<TKey, TValue> source, Expression<Func<TKey, TValue, bool>> predicate, ActiveExpressionOptions predicateOptions = null)
        {
            var synchronizableSource = source as ISynchronizable;
